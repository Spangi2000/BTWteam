...
class ObjectNotFound(mnkApiError):
...
class AlreadyExists(mnkApiError):
    def __init__(self, obj: type, obj_id_or_name: int | str):
        super().__init__(
...
class NoneAvailable(mnkApiError):
    def __init__(self, obj: type, obj_id_or_name: int | str):
        super().__init__(
...
class InactiveSession(mnkApiError):
    def __init__(self, obj: type, obj_id_or_name: int | str):
        super().__init__(
