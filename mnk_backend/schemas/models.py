...
from mnk_backend.models.db import RentStatus
from mnk_backend.schemas.base import Base
...
class mnkSessionPost(Base):
    item_type_id: int
    reservation_ts: datetime.datetime


class mnkSessionGet(Base):
    id: int
    user_id: int
    item_id: int
...
class mnkSessionPatch(BaseModel):
